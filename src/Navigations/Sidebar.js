    ...
    <>
      <nav className="navbar">
        ...
        <ul className="menus">
          ...
          <li className="menu_links">
            <a className="menu_link" href="/study">
              Study at Sedibeng
            </a>
          </li>
          <li className="menu_links">
            <a className="menu_link" href="/academic">
              Academic
            </a>
          </li>
          <li className="menu_links">
          ...
          <li className="menu_links">
            <a className="menu_link" href="/support">
              Support
            </a>
          </li>
          <li className="menu_links">
            <a className="menu_link" href="/gallery">
              Gallery
            </a>
          </li>
        </ul>
        <a href="/applications" className="apply_btn">
          Apply
        </a>
      </nav>
